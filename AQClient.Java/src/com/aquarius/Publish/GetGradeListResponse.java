...
public class GetGradeListResponse {
    ...
    @XmlElementRef(name = "GetGradeListResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> getGradeListResult;

    /**
     * Gets the value of the getGradeListResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the getGradeListResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
