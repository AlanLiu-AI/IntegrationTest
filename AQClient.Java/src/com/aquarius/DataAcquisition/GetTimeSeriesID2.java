...
@XmlRootElement(name = "GetTimeSeriesID2")
public class GetTimeSeriesID2 {

    @XmlElementRef(name = "parentLabel", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> parentLabel;
     ...
     *     
     */
    public JAXBElement<String> getParentLabel() {
        return parentLabel;
    }
     ...
     *     
     */
    public void setParentLabel(JAXBElement<String> value) {
