...
@XmlRootElement(name = "AppendTimeSeriesFromBytes")
public class AppendTimeSeriesFromBytes {

    protected Long id;
    @XmlElementRef(name = "csvbytes", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> csvbytes;
     ...
     *     
     */
    public JAXBElement<byte[]> getCsvbytes() {
        return csvbytes;
    }
     ...
     *     
     */
    public void setCsvbytes(JAXBElement<byte[]> value) {
        this.csvbytes = value;
    }
