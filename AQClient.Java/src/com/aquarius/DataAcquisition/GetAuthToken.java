...
public class GetAuthToken {
    ...
    @XmlElementRef(name = "encodedPassword", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> encodedPassword;
     ...
     *     
     */
    public JAXBElement<String> getEncodedPassword() {
     ...
     *     
     */
    public void setEncodedPassword(JAXBElement<String> value) {
